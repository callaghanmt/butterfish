...
import (
	...
	bf "github.com/callaghanmt/butterfish/butterfish"
	"github.com/callaghanmt/butterfish/util"
)
...
Prompts are stored in ~/.config/butterfish/prompts.yaml. Butterfish logs to the system temp dir, usually to /var/tmp/butterfish.log. To print the full prompts and responses from the OpenAI API, use the --verbose flag. Support can be found at https://github.com/callaghanmt/butterfish.
